...
export default function About() {
	return (
		<section className="py-15 px-10 bg-gray-950 text-center">
			<h2 className="text-gray-100 text-3xl font-bold mb-6">Quem sou eu?</h2>
			...
			<div className="max-w-6xl mx-auto flex flex-col md:flex-row md:items-center">
				...
				<p className="text-gray-200 leading-relaxed md:pl-10 mt-6 md:mt-0 text-xl md:text-3xl text-center">
